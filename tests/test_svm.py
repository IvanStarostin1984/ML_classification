...
from src.models.svm import grid_train_from_df, train_from_df
...
def test_grid_train_from_df() -> None:
    ...
    assert len(gs.cv_results_["params"]) == 8
...
def test_validate_prep_called(monkeypatch) -> None:
    ...
    monkeypatch.setattr(svm, "validate_prep", fake_validate)
